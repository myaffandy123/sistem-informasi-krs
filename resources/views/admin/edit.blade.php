                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin/edit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kode" type="text" class="form-control @error('kode') is-invalid @enderror"
                                    name="kode" value="{{ $data->kode }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ruang" type="text" class="form-control @error('ruang') is-invalid @enderror"
                                    name="ruang" value="{{ $data->ruang }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kelas" type="text" class="form-control @error('kelas') is-invalid @enderror"
                                    name="kelas" value="{{ $data->kelas }}" required>
